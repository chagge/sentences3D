function info = in3d_baserecall()

GTs = load('/share/data/sentences3D/NYU/ground_truths.mat');
GTs = GTs.GTs;
objdir = fullfile('/share/data/sentences3D/NYU', 'gtobjects_a');

spl = load('/share/data/sentences3D/NYU/split');
